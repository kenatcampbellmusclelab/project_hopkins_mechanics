...
sys.path.append('d:/ken/github/campbellmusclelab/models/fibersim/code/fiberpy/fiberpy/package/modules/analysis')
...
def characterize_models():
    ...
    # Different isotypes
    rel_dead_heads = [0, 0.0, 0.5]
    rel_force_dependence = [1, 0.25, 0.25]
    ...
    for i in range(len(rel_dead_heads)):
